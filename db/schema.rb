...
ActiveRecord::Schema[8.0].define(version: 2025_08_15_081725) do
  ...
  create_table "orders", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["assigned_by"], name: "index_orders_on_assigned_by"
    t.index ["assigned_to"], name: "index_orders_on_assigned_to"
